...
const PtMembers = () => {
  ...
  const ptMembers = customers.filter(() => true); // Placeholder
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-4 mb-4">
                    <Avatar src={member.photo} name={memberName} size="md" />
                    <div className="flex-1 min-w-0">
                      <h3 className="font-semibold text-dark-50 mb-1 truncate">{memberName}</h3>
                      <p className="text-sm text-dark-300 truncate">{member.email || 'No email'}</p>
                    </div>
                  </div>
      ...
      >
        <div className="space-y-6">
          ...
          <div className="flex justify-end pt-4">
            <button onClick={handleCloseProgressModal} className="btn-secondary">
              Close
            </button>
          </div>
        </div>
