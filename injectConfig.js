...
async function generateConfig() {
    try {
        ...
        const fileContent = `// This file is auto-generated by injectConfig.js during build
...
`;
        ...
        console.error("❌ Failed to generate config file from Remote Config. Ensure all required parameters are set:");
        console.error("   - API_KEY");
        console.error("   - APP_ID");
        console.error("   - AUTH_DOMAIN");
